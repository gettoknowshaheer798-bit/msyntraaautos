      ...
      <div className="mx-auto max-w-7xl px-6 pt-32 pb-16">
        ...
        <div className="mb-12 flex flex-col items-start">
          ...
          <p className="mt-4 max-w-xl text-xs font-light leading-relaxed text-white/60">
            Explore our complete collection of high-performance supercars,
            luxury SUVs, and bespoke vehicles.
          </p>
        </div>
        ...
        {vehicles.length > 0 ? (
          ...
          <div className="border border-white/10 px-6 py-20 text-center">
            <p className="text-xs font-light tracking-[0.2em] text-white/50 uppercase">
