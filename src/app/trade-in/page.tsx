    ...
    <div className="bg-[#f4f0eb] text-[#0d1c17] min-h-screen font-sans w-full">
        ...
        <div className="w-full px-8 md:px-16 lg:px-24 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center py-20 z-10">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="pt-2">
              <a
                href="#valuation-form"
                className="inline-flex items-center gap-3 px-6 py-3.5 border border-[#9e6d48]/50 text-[10px] tracking-[0.25em] text-[#e7e3dc] uppercase font-semibold hover:border-[#9e6d48] hover:bg-[#9e6d48] hover:text-[#0d1c17] transition-all"
              >
                HOW TRADE-IN WORKS <ArrowRight className="w-3.5 h-3.5" />
              </a>
            </div>
          </div>
      ...
      <section id="valuation-form" className="w-full px-8 md:px-16 lg:px-24 py-20">
        <div className="text-center max-w-xl mx-auto mb-12">
          <h2 className="font-serif text-3xl md:text-4xl font-light uppercase tracking-wider text-[#0d1c17] mb-2">
              ...
              <div key={s.number} className="relative z-10 flex items-center gap-2 bg-[#f4f0eb] px-3">
                <span
                  className={`w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-mono transition-colors ${
                    isActive
                      ? "bg-[#0d1c17] text-white"
                      : isCompleted
                      ? "bg-[#9e6d48] text-white"
                      : "bg-[#eae5dd] text-[#8a9992]"
                  }`}
                >
                  {s.number}
                </span>
                <span className={`text-[10px] tracking-[0.2em] uppercase font-mono ${isActive ? "text-[#0d1c17] font-semibold" : "text-[#8a9992]"}`}>
                  {s.label}
                </span>
              </div>
            );
        ...
        <div className="max-w-5xl mx-auto bg-[#eae5dd] border border-[#dcd5c9] grid grid-cols-1 lg:grid-cols-12 overflow-hidden shadow-sm min-h-[500px]">
          ...
          <div className="lg:col-span-7 p-8 md:p-12 space-y-6 flex flex-col justify-between">
            <div className="space-y-6">
              <div>
                <span className="text-[10px] tracking-[0.2em] text-[#9e6d48] font-mono block mb-1">
                  STEP 01
                </span>
                <h3 className="font-serif text-2xl md:text-3xl font-light text-[#0d1c17]">
                  Your Vehicle
                </h3>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#f4f0eb] border border-[#dcd5c9] text-xs py-3.5 px-3.5 pr-12 focus:outline-none focus:border-[#9e6d48]"
                  />
          ...
          <div className="lg:col-span-5 relative p-8 md:p-12 border-t lg:border-t-0 lg:border-l border-[#dcd5c9] flex flex-col justify-between overflow-hidden min-h-[400px]">
            ...
            <div className="relative z-10 space-y-6">
              <div className="w-9 h-9 rounded-full border border-[#9e6d48]/50 bg-[#f4f0eb]/80 backdrop-blur-sm flex items-center justify-center text-[#9e6d48]">
                <Sparkles className="w-4 h-4" />
              </div>

              <h4 className="font-serif text-2xl font-light text-[#0d1c17]">
                Why trade in with MSyntra?
              </h4>

              <div className="space-y-5 text-xs text-[#2d3833]">
                <div className="flex gap-3 items-start">
                  <TrendingUp className="w-4 h-4 text-[#9e6d48] flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="font-semibold text-[#0d1c17] block">Fair, market-based offers</span>
                    <p className="font-light text-[11px] text-[#4d5853]">Powered by real market data.</p>
                  </div>
                </div>

                <div className="flex gap-3 items-start">
                  <Tag className="w-4 h-4 text-[#9e6d48] flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="font-semibold text-[#0d1c17] block">Apply value toward your next car</span>
                    <p className="font-light text-[11px] text-[#4d5853]">Seamless and hassle-free.</p>
                  </div>
                </div>

                <div className="flex gap-3 items-start">
                  <ShieldCheck className="w-4 h-4 text-[#9e6d48] flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="font-semibold text-[#0d1c17] block">No obligation</span>
                    <p className="font-light text-[11px] text-[#4d5853]">Get your value with zero commitment.</p>
                  </div>
                </div>

                <div className="flex gap-3 items-start">
                  <Lock className="w-4 h-4 text-[#9e6d48] flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="font-semibold text-[#0d1c17] block">Fast and secure</span>
      ...
      <section className="w-full px-8 md:px-16 lg:px-24 py-16 border-t border-[#dcd5c9]">
        ...
        <h2 className="font-serif text-3xl md:text-4xl font-light uppercase tracking-wider text-[#0d1c17] mb-12">
          HOW IT WORKS
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-[#eae5dd] p-8 border border-[#dcd5c9] flex flex-col justify-between">
            <div>
              ...
              <Car className="w-7 h-7 text-[#0d1c17] mb-6 stroke-[1.25]" />
              <h3 className="text-xs font-semibold uppercase tracking-wider text-[#0d1c17] mb-2">
          ...
          <div className="bg-[#eae5dd] p-8 border border-[#dcd5c9] flex flex-col justify-between">
            <div>
              ...
              <FileCheck className="w-7 h-7 text-[#0d1c17] mb-6 stroke-[1.25]" />
              <h3 className="text-xs font-semibold uppercase tracking-wider text-[#0d1c17] mb-2">
                GET YOUR VALUE
              </h3>
              <p className="text-xs text-[#5d6863] font-light leading-relaxed">
          ...
          <div className="bg-[#eae5dd] p-8 border border-[#dcd5c9] flex flex-col justify-between">
            <div>
              ...
              <Tag className="w-7 h-7 text-[#0d1c17] mb-6 stroke-[1.25]" />
              <h3 className="text-xs font-semibold uppercase tracking-wider text-[#0d1c17] mb-2">
          ...
          <div className="bg-[#eae5dd] p-8 border border-[#dcd5c9] flex flex-col justify-between">
            <div>
              ...
              <Key className="w-7 h-7 text-[#0d1c17] mb-6 stroke-[1.25]" />
              <h3 className="text-xs font-semibold uppercase tracking-wider text-[#0d1c17] mb-2">
                DRIVE WHAT&apos;S NEXT
              </h3>
              <p className="text-xs text-[#5d6863] font-light leading-relaxed">
      ...
      {/* ------------------------------------------------------------- */}
      <section className="w-full bg-[#08120f] border-t border-white/10 text-[#8a9992] py-8 px-8 md:px-16 lg:px-24">
